...
interface TodoOrganizationsSublistProps {
    linkedIds: number[];
...
export interface TodoOrganizationsSublistRef {
    saveIfUnsaved: () => Promise<void>;
}

export const TodoOrganizationsSublist = forwardRef<TodoOrganizationsSublistRef, TodoOrganizationsSublistProps>(({ linkedIds, availableOrganizations, allOrganizationsMap, readOnly = false, onLinksChanged, onClickOrganization, onModeChange }, ref) => {
...
TodoOrganizationsSublist.displayName = 'TodoOrganizationsSublist'
